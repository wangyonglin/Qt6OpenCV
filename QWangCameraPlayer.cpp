#include "QWangCameraPlayer.h"

#include <QResizeEvent>

QWangCameraPlayer::QWangCameraPlayer(QWidget *parent)
    : QOpenGLWidget(parent),
      qWangCameraThreader(new QWangCameraThreader(this)),
      program(new QOpenGLShaderProgram(this))

{
    connect(qWangCameraThreader,&QWangCameraThreader::onRefreshFrame,this,&QWangCameraPlayer::onRefreshFrame);
}

void QWangCameraPlayer::play(QString name, int framerate)
{
    qWangCameraThreader->open(name);
}
void QWangCameraPlayer::stop()
{
    qWangCameraThreader->close();
}
void QWangCameraPlayer::initializeGL()
{
...
void QWangCameraPlayer::resizeGL(int width, int height)
{
    // 计算窗口横纵比
...
void QWangCameraPlayer::paintGL()
{
...
void QWangCameraPlayer::onRefreshFrame(const QImage &image)
{
...
void QWangCameraPlayer::resizeEvent(QResizeEvent *event)
{
